...
export var Upload = function (props) {
    ...
    return (React.createElement("div", { className: "chenlegion-upload-component" },
        React.createElement("div", { className: "chenlegion-upload-input", style: { display: "inline-block" }, onClick: handleClick },
            drag ? React.createElement(Dragger, { onFile: function (files) { return uploadFile(files); } }, children) : children,
            React.createElement("input", { className: "chenlegion-file-input", style: { display: "none" }, ref: fileInput, type: "file", onChange: handleFileChange, accept: accept, multiple: multiple })),
