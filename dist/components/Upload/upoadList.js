...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "chenlegion-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "chenlegion-upload-list-item", key: item.uid },
